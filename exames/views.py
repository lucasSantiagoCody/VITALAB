...
def cancelar_pedido(request, pedido_id):
    ...
    if pedido.usuario == request.user:
        ...
        messages.add_message(request, constants.ERROR, 'Este pedido de exame não pertence a você, portanto você não pode cancelar')
...
def permitir_abrir_exame(request, exame_id):
    ...
    if not exame.resultado:
        messages.add_message(request, constants.ERROR, 'Não existe arquivo de resultado')
